...
Next, I tested another filtration constraint. I excluded the 'year' measure, and I targeted the year 2020. The results further supported the theory that this was a calculation of one year in one county.

```Python
test2 = df3[
    (df3['BENE_COUNTY_DESC'] == 'Adams County') &
    (df3['BENE_STATE_DESC'] == 'Ohio') &
    (df3['YEAR'] == 2020) & (df2['MONTH'] != 'Year')
    ]
